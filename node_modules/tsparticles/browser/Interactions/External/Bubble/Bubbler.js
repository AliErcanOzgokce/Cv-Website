...
export class Bubbler extends ExternalInteractorBase {
    ...
    isEnabled() {
        const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = options.interactivity.events, divs = events.onDiv, divBubble = isDivModeEnabled("bubble" /* bubble */, divs);
        if (!(divBubble || (events.onHover.enable && mouse.position) || (events.onClick.enable && mouse.clickPosition))) {
            return false;
        }
        const hoverMode = events.onHover.mode;
        const clickMode = events.onClick.mode;
        return isInArray("bubble" /* bubble */, hoverMode) || isInArray("bubble" /* bubble */, clickMode) || divBubble;
    }
    ...
    interact() {
        ...
        if (hoverEnabled && isInArray("bubble" /* bubble */, hoverMode)) {
            ...
            divModeExecute("bubble" /* bubble */, divs, (selector, div) => this.singleSelectorHover(selector, div));
        }
    }
