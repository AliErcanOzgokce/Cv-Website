...
export class TrailMaker extends ExternalInteractorBase {
    ...
    isEnabled() {
        ...
        return ((mouse.clicking && mouse.inside && !!mouse.position && isInArray("trail" /* trail */, events.onClick.mode)) ||
            (mouse.inside && !!mouse.position && isInArray("trail" /* trail */, events.onHover.mode)));
    }
    reset() {
        // nothing to do
    }
